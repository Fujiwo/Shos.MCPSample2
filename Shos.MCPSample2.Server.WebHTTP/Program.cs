...
app.MapPost("/oauth/token", async (HttpContext context, OAuthService oauthService, OAuthConfiguration oauthConfig) =>
{
...
// Map the MCP server endpoint with HTTP transport - now protected with authentication
